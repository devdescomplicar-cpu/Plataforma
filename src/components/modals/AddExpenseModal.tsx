...
import { Wrench, Loader2, Calendar as CalendarIcon } from 'lucide-react';
import {
  Dialog,
  DialogContent,
  DialogDescription,
...
export function AddExpenseModal({
  ...
  const formatCurrency = (value: string): string => {
    ...
    // Formatar apenas números, sem símbolo R$
      ...
      <DialogContent className="sm:max-w-[500px] rounded-xl">
        <DialogHeader>
          <div className="flex items-center gap-3">
            ...
            <div>
              <DialogTitle className="text-xl">Adicionar Despesa</DialogTitle>
              <DialogDescription>
                Cadastre uma nova despesa para este veículo
              </DialogDescription>
            </div>
          </div>
        </DialogHeader>
